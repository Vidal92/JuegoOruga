...
import escenarios.panelEditable;
import java.awt.*;
...
public class ambienteOruga extends Canvas implements KeyListener, Runnable
{
    String Tecla = "";
    int Codigo = 0;
    public int i, j, direccion, k, l, contador, aux, aux2, NMartillos, NHachas, NEscudos;
    ...
    String [] initial;
    public boolean yaGeneroBomba=false, perdio=false;
